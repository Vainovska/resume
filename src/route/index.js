...
var header = {
  ...
  address: 'Ukraine,Zaporizhia,Zestafonska-6',
}

var footer = {
  social: {
    email: {
      text: 'ivanovo@mail.com',
      href: 'mailto:ivanovo@mail.com',
    },
    phone: {
      text: '+380670000123',
      numhref: 'tel:+380670000123',
    },
    linkedin: {
      text: 'LinkedIn',
          ...
          projects: [
            {
              ...
              awards: [
                {
                  name: 'ghfhgjhkfzdsarefguh',
                },
                {
                  name: 'bjhffdhjlhjyfrsefsx',
                },
              ],
            },
          ],
...
// ================================================================
router.get('/bootstrept', function (req, res) {
  // res.render генерує нам HTML сторінку

  //            ↙ cюди вводимо назву файлу з сontainer
  res.render('bootstrept', {
    layout: 'bootstrept',
  })
  //                  ↑↑ сюди вводимо JSON дані
})
